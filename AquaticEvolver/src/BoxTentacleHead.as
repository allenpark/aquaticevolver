package
{
	...
	public class BoxTentacleHead extends B2FlxSprite
	{
		...
		public function BoxTentacleHead(x:Number, y:Number, owner:Creature, Graphic:Class=null, width:Number=0, height:Number=0)
		{
			this.owner = owner;
		...
		{     
			...
			var b2bb:B2BodyBuilder = new B2BodyBuilder().withShape(boxShape).withType(b2Body.b2_dynamicBody)
				.withDensity(0.01).withLinearDamping(2).withData(new CollisionData(this.owner, SpriteType.TENTACLEHEAD));
			return b2bb;
		}
	}
}
